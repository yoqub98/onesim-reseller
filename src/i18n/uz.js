const uz = {
  ...
  catalog: {
    ...
    detailsModal: {
      ...
      packageInfo: "Paket ma'lumotlari",
      pricing: "Narxlar",
      b2cPrice: "B2C narxi",
      resellerPrice: "Hamkor narxi",
      yourDiscount: "Sizning chegirmangiz",
      coverage: "Qamrov hududlari",
      countriesCovered: "ta davlat",
      operators: "Operatorlar",
      network: "Tarmoq",
      features: "Xususiyatlar",
      dataOnly: "Faqat internet",
      instantActivation: "Tezkor aktivatsiya",
      hotspotSupported: "Hotspot qo'llab-quvvatlanadi",
      topUpSupported: "Top-up qo'llab-quvvatlanadi",
      smsSupported: "SMS qo'llab-quvvatlanadi",
      noSms: "SMS yo'q",
      data: "Internet hajmi",
      validity: "Amal qilish muddati",
      speed: "Tarmoq tezligi",
      packageType: "Paket turi",
